...
class MusicController:
    ...
    def stereo_on(self):
        with eiscp.eISCP('192.168.2.100') as receiver:
            resp = receiver.raw('PWRQSTN')
            print(resp)

            receiver.raw('SLI11')  # Input source STRM BOX
            receiver.command('volume 70')
